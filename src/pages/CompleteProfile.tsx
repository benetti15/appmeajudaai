    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 to-accent/10 p-6">
      <Card className="w-full max-w-2xl bg-white/90 backdrop-blur-xl border-0 shadow-2xl">
        <CardHeader className="space-y-3 text-center pb-6">
          ...
          <h1 className="flex items-center justify-center gap-2 text-3xl font-display font-black mb-2">
          ...
          <CardTitle className="text-2xl font-display font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
            Complete seu Perfil
          </CardTitle>
