...
const Auth = () => {
  ...
  const handleGoogleSignIn = async (selectedType?: "client" | "professional") => {
    ...
    sessionStorage.setItem('google_user_type', selectedType);
            ...
            <div className="bg-card rounded-3xl shadow-xl border border-border/50 overflow-hidden">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="signin" className="p-4 sm:p-6 pt-4 space-y-4 animate-fade-in">
                  {/* Google Button - Login doesn't need type selection */}
                  <Button
                    type="button"
                    variant="outline"
                    onClick={() => {
                    ...
                    disabled={isLoading}
                    className="w-full h-12 rounded-xl border-2 transition-all hover:bg-muted/50"
                  >
                ...
                <TabsContent value="signup" className="p-4 sm:p-6 pt-4 space-y-4 animate-fade-in">
                  <form onSubmit={handleSignUp} className="space-y-3">
                    ...
                    {/* Google Button - below account type selection */}
                    <Button
                      type="button"
                      variant="outline"
                    ...
                    <div className="relative py-2">
                      ...
                      <div className="relative flex justify-center">
                        <span className="bg-card px-3 text-xs text-muted-foreground uppercase tracking-wider">ou preencha o formulário</span>
                      </div>
                    </div>
